...
public class SimpleShoot : MonoBehaviour
{
    ...
    [Tooltip("Raycast distance")][SerializeField] private float rayDistance = 100f;
    [SerializeField] private LayerMask hitLayers; // 追加する部分
    ...
    void Shoot()
    {
        ...
        RaycastHit hit;
        if (Physics.Raycast(barrelLocation.position, barrelLocation.forward, out hit, rayDistance))
        {
